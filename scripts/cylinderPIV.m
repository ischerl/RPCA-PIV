...
clear S0* L0* S1* L1*
%% Plot results
load ../data/plotparams.mat cylinderPIVcmap cylinderPIVcax
...
for ind = 1%:m(3)
    ...
    i = i+1;
    subplot(rows, cols, i)
    imagesc(flipud(fliplr(curl(Lu01(:,:,ind),Lv01(:,:,ind))')));
    shading flat; axis equal; axis tight; axis off;
    title('L, \lambda = 0.1')
    caxis(cylinderPIVcax); colormap(cylinderPIVcmap)
    
    
    i = i+1;
    subplot(rows, cols, i)
    imagesc(flipud(fliplr(curl(Lu02(:,:,ind),Lv02(:,:,ind))')));
    shading flat; axis equal; axis tight; axis off;
    title('L, \lambda = 0.2')
    caxis(cylinderPIVcax); colormap(cylinderPIVcmap)
    ...
    i = i+1;
    subplot(rows, cols, i)
    imagesc(flipud(fliplr(curl(Lu05(:,:,ind),Lv05(:,:,ind))')));
    shading flat; axis equal; axis tight; axis off;
    title('L, \lambda = 0.5')
    caxis(cylinderPIVcax); colormap(cylinderPIVcmap)
    ...
    i = i+1;
    subplot(rows, cols, i)
    imagesc(flipud(fliplr(curl(Lu1(:,:,ind),Lv1(:,:,ind))')));
    shading flat; axis equal; axis tight; axis off;
    title('L, \lambda = 1')
    caxis(cylinderPIVcax); colormap(cylinderPIVcmap)
    ...
    i = i+1;
    subplot(rows, cols, i)
    imagesc(flipud(fliplr(curl(Lu2(:,:,ind),Lv2(:,:,ind))')));
    shading flat; axis equal; axis tight; axis off;
    title('L, \lambda = 2')
    caxis(cylinderPIVcax); colormap(cylinderPIVcmap)
    ...
    i = i+1;
    subplot(rows, cols, i)
    imagesc(flipud(fliplr(curl(Lu5(:,:,ind),Lv5(:,:,ind))')));
    shading flat; axis equal; axis tight; axis off;
    title('L, \lambda = 5')
    caxis(cylinderPIVcax); colormap(cylinderPIVcmap)
    ...
    i = i+1;
    subplot(rows, cols, i)
    imagesc(flipud(fliplr(curl(Lu10(:,:,ind),Lv10(:,:,ind))')));
    shading flat; axis equal; axis tight; axis off;
    title('L, \lambda = 10')
    caxis(cylinderPIVcax); colormap(cylinderPIVcmap) 
    ...
    i = i+1;
    subplot(rows, cols, i)
    imagesc(flipud(fliplr(curl(Su01(:,:,ind),Sv01(:,:,ind))')));
    shading flat; axis equal; axis tight; axis off; title('S, \lambda = 0.1')
    caxis(cylinderPIVcax); colormap(cylinderPIVcmap)
    
    i = i+1;
    subplot(rows, cols, i)
    imagesc(flipud(fliplr(curl(Su02(:,:,ind),Sv02(:,:,ind))')));
    shading flat; axis equal; axis tight; axis off;
    title('S, \lambda = 0.2')
    caxis(cylinderPIVcax); colormap(cylinderPIVcmap)
    ...
    i = i+1;
    subplot(rows, cols, i)
    imagesc(flipud(fliplr(curl(Su05(:,:,ind),Sv05(:,:,ind))')));
    shading flat; axis equal; axis tight; axis off;
    title('S, \lambda = 0.5')
    caxis(cylinderPIVcax); colormap(cylinderPIVcmap)
    ...
    i = i+1;
    subplot(rows, cols, i)
    imagesc(flipud(fliplr(curl(Su1(:,:,ind),Sv1(:,:,ind))')));
    shading flat; axis equal; axis tight; axis off;
    title('S, \lambda = 1')
    caxis(cylinderPIVcax); colormap(cylinderPIVcmap)
    ...
    i = i+1;
    subplot(rows, cols, i)
    imagesc(flipud(fliplr(curl(Su2(:,:,ind),Sv2(:,:,ind))')));
    shading flat; axis equal; axis tight; axis off;
    title('S, \lambda = 2')
    
    i = i+1;
    subplot(rows, cols, i)
    imagesc(flipud(fliplr(curl(Su5(:,:,ind),Sv5(:,:,ind))')));
    shading flat; axis equal; axis tight; axis off;
    title('S, \lambda = 5')
    caxis(cylinderPIVcax); colormap(cylinderPIVcmap)
    ...
    i = i+1;
    subplot(rows, cols, i)
    imagesc(flipud(fliplr(curl(Su10(:,:,ind),Sv10(:,:,ind))')));
    shading flat; axis equal; axis tight; axis off;
    title('S, \lambda = 10')
    caxis(cylinderPIVcax); colormap(cylinderPIVcmap)
